        ...
        public function rules(){
            return[
                ['field'    => 'siswa_nis',
                 ...
                 ['field'    => 'siswa_jenis_kelamin',
                 'label'    => 'Jenis Kelamin',
                 'rules'    => 'required|xss_clean'],
                 ['field'    => 'siswa_tempat_lahir',
                 'label'    => 'Tempat Lahir',
                 'rules'    => 'trim|xss_clean'],
                 ['field'    => 'siswa_agama',
                 'label'    => 'Agama',
                 'rules'    => 'trim|xss_clean'],
                 ['field'    => 'siswa_kewarganegaraan',
                 'label'    => 'Kewarganegaraan',
                 'rules'    => 'trim|xss_clean'],
                 ['field'    => 'siswa_alamat_jalan',
                 'label'    => 'Alamat',
                 'rules'    => 'trim|xss_clean'],
                 ['field'    => 'siswa_alamat_rtrw',
                 'label'    => 'RT/RW',
                 'rules'    => 'trim|xss_clean'],
                 ['field'    => 'siswa_alamat_desa',
                 'label'    => 'Desa/Kelurahan',
                 'rules'    => 'trim|xss_clean'],
                 ['field'    => 'siswa_alamat_kecamatan',
                 'label'    => 'Kecamatan',
                 'rules'    => 'trim|xss_clean'],
                 ['field'    => 'siswa_alamat_kabupaten',
                 'label'    => 'Kota/Kabupaten',
                 'rules'    => 'trim|xss_clean'],
                 ['field'    => 'siswa_alamat_provinsi',
                 'label'    => 'Provinsi',
                 'rules'    => 'trim|xss_clean'],
                 ['field'    => 'siswa_alamat_kodepos',
                 'label'    => 'Kode POS',
                 'rules'    => 'trim|xss_clean']
            ];
        }
