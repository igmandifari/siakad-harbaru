                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="d-none d-sm-table-cell text-center">
                                    <img class="img-avatar img-avatar32" src="<?= base_url('assets/template/back') ?>/media/avatars/avatar16.jpg" alt="">
                                </td>
                                <td class="font-w600">
                                    Jeffrey Shaw                                </td>
                                <td class="d-none d-sm-table-cell text-center">
                            ...
                            <tr>
                                ...
                                <td class="d-none d-sm-table-cell text-center">
                                    <img class="img-avatar img-avatar32" src="<?= base_url('assets/template/back') ?>/media/avatars/avatar4.jpg" alt="">
                                </td>
                                <td class="font-w600">
                                    Betty Kelley                                </td>
                                <td class="d-none d-sm-table-cell text-center">
                            ...
                            <tr>
                                ...
                                <td class="d-none d-sm-table-cell text-center">
                                    <img class="img-avatar img-avatar32" src="<?= base_url('assets/template/back') ?>/media/avatars/avatar14.jpg" alt="">
                                </td>
                                <td class="font-w600">
                                    Jose Parker                                </td>
                                <td class="d-none d-sm-table-cell text-center">
                            ...
                            <tr>
                                ...
                                <td class="d-none d-sm-table-cell text-center">
                                    <img class="img-avatar img-avatar32" src="<?= base_url('assets/template/back') ?>/media/avatars/avatar6.jpg" alt="">
                                </td>
                                <td class="font-w600">
                                    Melissa Rice                                </td>
                                <td class="d-none d-sm-table-cell text-center">
                            ...
                            <tr>
                                ...
                                <td class="d-none d-sm-table-cell text-center">
                                    <img class="img-avatar img-avatar32" src="<?= base_url('assets/template/back') ?>/media/avatars/avatar12.jpg" alt="">
                                </td>
                                <td class="font-w600">
                                    Jeffrey Shaw                                </td>
                                <td class="d-none d-sm-table-cell text-center">
