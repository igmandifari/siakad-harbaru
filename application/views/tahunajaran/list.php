                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="<?=base_url('tahunajaran/ubah/').$tahunajaran->tahunajaran_id;?>">
                                                            ...
                                                            <button type="button" class="hapus btn btn-sm btn-warning js-tooltip-enabled push mb-md-0" data-toggle="tooltip" title="" data-id="$tahunajaran->tahunajaran_id;?>" data-original-title="Hapus">
