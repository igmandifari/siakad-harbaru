...
<html lang="en">
    <head>
        ...
        <title>Halaman Tidak Ditemukan | SiakadHarbaru</title>
                    ...
                    <div class="hero-inner text-center">
                        <div class="content content-full bg-white overflow-hidden">
                            <div class="py-4">
                                ...
                                <h2 class="h3 font-w300 text-muted invisible mb-5" data-toggle="appear" data-class="animated fadeInUp">Kami mohon maaf, halaman yang kamu cari tidak ditemukan..</h2>
                                <!-- END Error Header -->
                        ...
                        <div class="content content-full font-size-sm text-muted">
                            <!-- Error Footer -->
                            <a class="link-fx" href="<?=base_url('dasbor');?>">Kembali Ke Dasbor</a>
                            <!-- END Error Footer -->
                        </div>
                    </div>
                </div>
