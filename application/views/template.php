...
<head>
    ...
    <link rel="shortcut icon" href="<?= base_url('assets/template/back') ?>/media/favicons/favicon.png">
    <link rel="icon" type="image/png" sizes="192x192" href="<?= base_url('assets/template/back') ?>/media/favicons/favicon-192x192.png">
    <link rel="apple-touch-icon" sizes="180x180" href="<?= base_url('assets/template/back') ?>/media/favicons/apple-touch-icon-180x180.png">
    <!-- END Icons -->

    <!-- Stylesheets -->
    <!-- Fonts and OneUI framework -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400italic,600,700%7COpen+Sans:300,400,400italic,600,700">
    <link rel="stylesheet" id="css-main" href="<?= base_url('assets/template/back') ?>/css/oneui.min.css">
    <link rel="stylesheet" id="css-theme" href="<?= base_url('assets/template/back') ?>/css/themes/amethyst.min.css"> -->
    <!-- END Stylesheets -->
</head>
        ...
        <aside id="side-overlay" class="font-size-sm">
            ...
            <div class="content-header border-bottom">
                ...
                <a class="img-link mr-1" href="javascript:void(0)">
                    <img class="img-avatar img-avatar32" src="<?= base_url('assets/template/back') ?>/media/avatars/avatar10.jpg" alt="">
                </a>
                <!-- END User Avatar -->
                                ...
                                <div class="block-content">
                                    ...
                                    <ul class="nav-items mb-0">
                                        <li>
                                            <a class="media py-2" href="javascript:void(0)">
                                                <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48" src="<?= base_url('assets/template/back') ?>/media/avatars/avatar5.jpg" alt="">
                                        ...
                                        <li>
                                            <a class="media py-2" href="javascript:void(0)">
                                                <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48" src="<?= base_url('assets/template/back') ?>/media/avatars/avatar9.jpg" alt="">
                                                    <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <li>
                                            <a class="media py-2" href="javascript:void(0)">
                                                <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48" src="<?= base_url('assets/template/back') ?>/media/avatars/avatar3.jpg" alt="">
                                        ...
                                        <li>
                                            <a class="media py-2" href="javascript:void(0)">
                                                <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48" src="<?= base_url('assets/template/back') ?>/media/avatars/avatar13.jpg" alt="">
                                                    <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-warning"></span>
                                                </div>
                                                <div class="media-body">
...
-->
        <nav id="sidebar" aria-label="Main Navigation">
            ...
            <div class="content-header bg-white-5">
                <!-- Logo -->
                <a class="font-w600 text-dual" href="<?= base_url('siswa') ?>">
                    <i class="fa fa-circle-notch text-primary"></i>
                    <span class="smini-hide">
                        <span class="font-w700 font-size-h5">Siakad</span> <span class="font-w400">Harba</span>
                    </span>
                </a>
                <!-- END Logo -->
                ...
                <div>
                    ...
                    <div class="dropdown d-inline-block ml-3">
                        ...
                        <div class="dropdown-menu dropdown-menu-right font-size-sm smini-hide border-0" aria-labelledby="sidebar-themes-dropdown">
                            ...
                            <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="<?= base_url('assets/template/back') ?>/css/themes/amethyst.min.css" href="#">
                                <span>Amethyst</span>
                                <i class="fa fa-circle text-amethyst"></i>
                            </a>
                            <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="<?= base_url('assets/template/back') ?>/css/themes/city.min.css" href="#">
                                <span>City</span>
                                <i class="fa fa-circle text-city"></i>
                            </a>
                            <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="<?= base_url('assets/template/back') ?>/css/themes/flat.min.css" href="#">
                                <span>Flat</span>
                                <i class="fa fa-circle text-flat"></i>
                            </a>
                            <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="<?= base_url('assets/template/back') ?>/css/themes/modern.min.css" href="#">
                                <span>Modern</span>
                                <i class="fa fa-circle text-modern"></i>
                            </a>
                            <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="<?= base_url('assets/template/back') ?>/css/themes/smooth.min.css" href="#">
                                <span>Smooth</span>
            ...
            <div class="content-side content-side-full">
                <ul class="nav-main">
                    ...
                    foreach ($main_menu as $main){
                        ...
                        if ($submenu->num_rows() > 0) {
                            ...
                            echo " <li class='nav-main-item'>
                                    <a class='nav-main-link nav-main-link-submenu' data-toggle='submenu' aria-haspopup='true' aria-expanded='true' href='#'>
                                        <span class='nav-main-link-name'>".$main->nama_menu."</span>
                                    </a>
                                <ul class='nav-main-submenu'>";
                                 foreach ($submenu->result() as $sub) {
                                        echo "<li class='nav-main-link'>" . anchor($sub->link, "<i class='" . $sub->icon . "'></i><span class='title'> " . ($sub->nama_menu)) . "</span></li>";
                                    }
                        ...
                        // tampilkan main menu
                        echo "<li class='nav-main-link'>" . anchor($main->link, "<i class='" . $main->icon . "'></i><span class='nav-main-link-name'> " . ($main->nama_menu)) . "</span></li>";
                    }
                }
                    ?>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown d-inline-block ml-2">
                        <button type="button" class="btn btn-sm btn-dual" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded" src="<?= base_url('assets/template/back') ?>/media/avatars/avatar10.jpg" alt="Header Avatar" style="width: 18px;">
                            <span class="d-none d-sm-inline-block ml-1">Adam</span>
                            <i class="fa fa-fw fa-angle-down d-none d-sm-inline-block"></i>
                        </button>
                        <div class="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="page-header-user-dropdown">
                            <div class="p-3 text-center bg-primary">
                                <img class="img-avatar img-avatar48 img-avatar-thumb" src="<?= base_url('assets/template/back') ?>/media/avatars/avatar10.jpg" alt="">
                            </div>
                            <div class="p-2">
        ...
        <main id="main-container">
            ...
            <!-- Hero -->
            <div class="bg-image overflow-hidden" style="background-image: url('<?= base_url('assets/template/back') ?>/media/photos/photo3@2x.jpg');">
            ...
            <div class="content py-3">
                <div class="row font-size-sm">
                    <div class="col-sm-6 order-sm-2 py-1 text-center text-sm-right">
                        Made with <i class="fa fa-heart text-danger"></i> by <a class="font-w600" href="https://1.envato.market/ydb" target="_blank">sunflower</a>
                    </div>
    ...
    to handle those dependencies through webpack. Please check out <?= base_url('assets/template/back') ?>/_es6/main/bootstrap.js for more info.

    If you like, you could also include them separately directly from the <?= base_url('assets/template/back') ?>/js/core folder in the following
    order. That can come in handy if you would like to include a few of them (eg jQuery) from a CDN.

    <?= base_url('assets/template/back') ?>/js/core/jquery.min.js
    <?= base_url('assets/template/back') ?>/js/core/bootstrap.bundle.min.js
    <?= base_url('assets/template/back') ?>/js/core/simplebar.min.js
    <?= base_url('assets/template/back') ?>/js/core/jquery-scrollLock.min.js
    <?= base_url('assets/template/back') ?>/js/core/jquery.appear.min.js
    <?= base_url('assets/template/back') ?>/js/core/js.cookie.min.js
-->
    <script src="<?= base_url('assets/template/back') ?>/js/oneui.core.min.js"></script>

    <!--
    OneUI JS

    Custom functionality including Blocks/Layout API as well as other vital and optional helpers
    webpack is putting everything together at <?= base_url('assets/template/back') ?>/_es6/main/app.js
-->
    <script src="<?= base_url('assets/template/back') ?>/js/oneui.app.min.js"></script>

    <!-- Page JS Plugins -->
    <script src="<?= base_url('assets/template/back') ?>/js/plugins/chart.js/Chart.bundle.min.js"></script>

    <!-- Page JS Code -->
    <script src="<?= base_url('assets/template/back') ?>/js/pages/be_pages_dashboard.min.js"></script>
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item open">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link active" href="be_forms_elements.html">
                                        <span class="nav-main-link-name">Elements</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
