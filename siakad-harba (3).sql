...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 24, 2019 at 04:42 PM
...
(5, 0, 0, 'kaaasase', 'Pria', 'k', '0000-00-00', 'Kristen Protestan', NULL, 'k', 'j', 'jk', 'j', 'j', 'j', 'j', NULL, '', '', NULL, '0', '', '', '', '', '', '', '', '', '', '', NULL, '0', '', '', '', '', '', '', '', '', '', '', NULL, '0', '', '', '', '', '', '', '', '');
...
--
ALTER TABLE `matpel`
  MODIFY `matpel_id` int(11) NOT NULL AUTO_INCREMENT;
